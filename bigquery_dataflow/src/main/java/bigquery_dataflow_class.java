...
public class bigquery_dataflow_class {
...
//        Reading and writing to table.
        ...
        products_view_rows.apply(
                ...
                BigQueryIO.writeTableRows()
                        .to(("york-cdf-start:final_jaya_mohan.cust_tier_code-sku-total_no_of_product_java"))
        ...
        sales_rows.apply(
                "Write to BigQuery products table",
                BigQueryIO.writeTableRows()
                        .to(("york-cdf-start:final_jaya_mohan.cust_tier_code-sku-total_sales_amount_java"))
